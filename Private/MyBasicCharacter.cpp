...
void AMyBasicCharacter::EquipWeapon(AMyWeaponActor* Weapon)
{
	if (Weapon)
	{
...
void AMyBasicCharacter::AddWeapon(AMyWeaponActor* Weapon)
{
	if (Weapon)
	{
...
void AMyBasicCharacter::SetCurrentWeapon(AMyWeaponActor* NewWeapon, AMyWeaponActor* LastWeapon)
{
	AMyWeaponActor* LocalLastWeapon = NULL;
	if (LastWeapon != NULL)
	{
...
void AMyBasicCharacter::SpawnDefaultInventory()
{
	...
	if (DefaultInventoryClasses[0])
	{
		...
		AMyWeaponActor* NewWeapon = WRLD->SpawnActor<AMyWeaponActor>(DefaultInventoryClasses[0], SpawnInfo);
		AddWeapon(NewWeapon);
	}
